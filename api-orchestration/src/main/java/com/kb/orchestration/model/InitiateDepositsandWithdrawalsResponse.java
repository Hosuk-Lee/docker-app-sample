...
import com.kb.orchestration.model.InitiateDepositsandWithdrawalsResponseSavingsAccountFacility;
import io.swagger.v3.oas.annotations.media.Schema;
import java.util.Objects;

/**
 * Output: InBQ Initialize deposit or withdrawal transaction
 */
@Schema(description = "Output: InBQ Initialize deposit or withdrawal transaction")
...
public class InitiateDepositsandWithdrawalsResponse {
  ...
  private InitiateDepositsandWithdrawalsResponseSavingsAccountFacility savingsAccountFacility = null;
