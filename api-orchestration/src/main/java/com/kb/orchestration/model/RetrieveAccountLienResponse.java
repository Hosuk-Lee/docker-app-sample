...
import com.kb.orchestration.model.InitiateAccountLienRequestAccountLien;
import io.swagger.v3.oas.annotations.media.Schema;
import java.util.Objects;

/**
 * Output: ReBQ Retrieve details about an account lien
 */
@Schema(description = "Output: ReBQ Retrieve details about an account lien")
...
public class RetrieveAccountLienResponse {
  ...
  public RetrieveAccountLienResponse accountLien(InitiateAccountLienRequestAccountLien accountLien) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RetrieveAccountLienResponse retrieveAccountLienResponse = (RetrieveAccountLienResponse) o;
    return Objects.equals(this.accountLien, retrieveAccountLienResponse.accountLien);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveAccountLienResponse {\n");
