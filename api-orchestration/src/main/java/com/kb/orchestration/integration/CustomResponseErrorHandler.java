...
// String 형식의 JSON을 ObjectMapper를 활용해 객체 타입으로 변환합니다.
        ...
        if (HttpStatus.INTERNAL_SERVER_ERROR == HttpStatus.valueOf(errorResponse.getStatus()) &&
                errorResponse.getError().equals("Business Error")) {
            throw new BusinessExcpeion(CErrorCode.builder()
