...
/**
 * Input: UpBQ Update details about a reference entry for the customer
 */
@Schema(description = "Input: UpBQ Update details about a reference entry for the customer")
@Validated
