<template>
  ...
  <div class="flex-shrink-0 p-3" style="width: 280px; overflow-y: scroll;">
    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#sample-collapse" aria-expanded="true">
          Sample
        </button>
        <div class="collapse show" id="sample-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
