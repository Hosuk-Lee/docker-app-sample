...
/**
 * Input: RqCR Request manual intervention with an entry (e.g. refresh content)
 */
@Schema(description = "Input: RqCR Request manual intervention with an entry (e.g. refresh content)")
@Validated
