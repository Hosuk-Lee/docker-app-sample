package com.kb.sample.savings.domain.transactionManager.command;
...
import com.kb.sample.savings.domain.transactionManager.repository.CmpenTranMgtRepository;
